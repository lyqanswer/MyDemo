...
public class PollingService extends Service {
	...
	private void showNotification() {
		...
		mNotification = new Notification.Builder(getApplicationContext()).setContentTitle("" + getResources().getString(R.string.app_name)).setContentIntent(pendingIntent).build();
