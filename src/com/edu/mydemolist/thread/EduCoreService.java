...
public class EduCoreService extends Service {
	...
	private static final String TAG = "EduCoreService";

	// 任务执行周期，单位ms
	private static final int UPDATE_TIME = 5 * 1000;
	// 任务的线程
	 ...
	 * 上传用户行为数据
	 */
	private void uploadBehaviorData() {
		System.out.println(TAG + "--uploadBehaviorData" + "上传用户行为数据");
	}

	/**
	 * 用户信息
	 */
	private void uploadOffLineUserData() {
		System.out.println(TAG + "--uploadOffLineUserData" + "获取用户信息");
	}
