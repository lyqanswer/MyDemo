...
import com.edu.mydemolist.MyApplication;
 ...
 * <p>
 * PS: 由于发现timer每次cancle()之后不能重新schedule方法,所以计时完毕只恐timer. 每次开始计时的时候重新设置timer,
 * 没想到好办法初次下策 注意把该类的onCreate()onDestroy()和activity的onCreate()onDestroy()同步处理
 * 
 */
